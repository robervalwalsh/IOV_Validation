...
void TrackerClusterAnalysis::Loop()
{
   ...
   TH1F * ClusterCharge_TIB  = new TH1F("ClusterCharge_TIB",  "cluster charge per unit length for TIB",  100, 0, 1000);
   TH1F * ClusterCharge_TOB  = new TH1F("ClusterCharge_TOB",  "cluster charge per unit length for TOB",  100, 0, 1000);
   TH1F * ClusterCharge_TIDp = new TH1F("ClusterCharge_TIDp", "cluster charge per unit length for TID+", 100, 0, 1000);
   TH1F * ClusterCharge_TIDm = new TH1F("ClusterCharge_TIDm", "cluster charge per unit length for TID-", 100, 0, 1000);
   TH1F * ClusterCharge_TECp = new TH1F("ClusterCharge_TECp", "cluster charge per unit length for TEC+", 100, 0, 1000);
   TH1F * ClusterCharge_TECm = new TH1F("ClusterCharge_TECm", "cluster charge per unit length for TEC-", 100, 0, 1000);
